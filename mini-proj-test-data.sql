...
--- DATA ---
--- Users ---
insert into users values ('u1', 'Maheen Lynn', 'aeg$sdg');
insert into users values ('u2', 'Leena Markham', 'hasdf&d');
insert into users values ('u3', 'Branden Escobar', 'uhasdf*3');
insert into users values ('u4', 'Digby Tierney', 'uhasdf*3');
insert into users values ('u5', 'Harriet Beck', 'uhasdf*3');
insert into users values ('u6', 'Aron Gu', 'uhasdf*3');
insert into users values ('u7', 'Jeevan Dillard', 'uhasdf*3');
insert into users values ('u8', 'Laaibah Cano', 'uhasdf*3');
insert into users values ('u9', 'Ameila Pike', 'uhasdf*3');
insert into users values ('u10','Davood Rafiei', 'uhasdf*3');
insert into users values ('u11', 'Spencer Schimdt', 'uhasdf*3');
insert into users values ('u12', 'Ryder Catonio', 'uhasdf*3');
insert into users values ('u13', 'Dradelli Guy', 'uhasdf*3');
insert into users values ('u14', 'Aron Gu', 'uhasdf*3');
insert into users values ('u15', 'Mark Sanchez', 'uhasdf*3');
insert into users values ('u16', 'Marion Trap', 'uhasdf*3');
insert into users values ('u17', 'Mackenzie Parks', 'uhasdf*3');
insert into users values ('u18', 'Daria Blackburn', 'uhasdf*3');
insert into users values ('u19', 'Samuel Dixon', 'uhasdf*3');
insert into users values ('u20','Hamed Mirzaei', 'uhasdf*3');
insert into users values ('u21', 'Amelia Pike', 'uhasdf*3');
insert into users values ('u22', 'Quinn Mccartney', 'uhasdf*3');
insert into users values ('u23', 'Brenden Akhtar', 'uhasdf*3');
insert into users values ('u24', 'Catrina Maxwell', 'uhasdf*3');
insert into users values ('u25', 'Darsh Snyder', 'uhasdf*3');
insert into users values ('u26', 'Pheobe Shannon', 'uhasdf*3');
insert into users values ('u27', 'Judy Walsh', 'uhasdf*3');
insert into users values ('u28', 'Bret Bartlett', 'uhasdf*3');
insert into users values ('u29', 'Diogo Lowry', 'uhasdf*3');
insert into users values ('u30', 'Rudra Duke', 'uhasdf*3');
insert into users values ('u31', 'Mike Smith', 'uhasdf*3');
insert into users values ('u32', 'Conner Wang', 'uhasdf*3');
insert into users values ('u33', 'Saim Hays', 'uhasdf*3');
insert into users values ('u34', 'Jeanne Carlson', 'uhasdf*3');
insert into users values ('u35', 'John-Paul Whittaker', 'uhasdf*3');
insert into users values ('u36', 'Bjorn Partridge', 'uhasdf*3');
insert into users values ('u37', 'Dominic Chen', 'uhasdf*3');
insert into users values ('u38', 'Aleah Mendoza', 'uhasdf*3');
insert into users values ('u39', 'Kiyan Underwood', 'uhasdf*3');
insert into users values ('u40', 'Wendy Fernandez', 'uhasdf*3');
insert into users values ('u41', 'Shamima Gonzales', 'uhasdf*3');
insert into users values ('u42', 'Mike Smith', 'uhasdf*3');
--- test user ---
insert into users values ('30', 'David Zhang', 'uhasdf*3');
...
--- Artists ---
insert into artists values ('a1', 'Lady Gaga', 'United States', 'aksdjf');
insert into artists values ('a2', 'OneRepublic', 'United States', 'batMan2');
insert into artists values ('a3', 'Imagine Dragons', 'United States', 'uhasdf*3');
insert into artists values ('a4', 'PSY', 'South Korea', 'uhasdf*3');
insert into artists values ('a5', 'P!nk', 'American', 'uhasdf*3');
insert into artists values ('a6', 'Nate Reuss', 'American', 'uhasdf*3');
insert into artists values ('a7', 'Kelly Clarkson', 'United States', 'uhasdf*3');
insert into artists values ('a8', 'Janelle Monáe', 'United States', 'uhasdf*3');
insert into artists values ('a9', 'Maroon 5', 'United States', 'uhasdf*3');
insert into artists values ('a10', 'Drake', 'Canada', 'uhasdf*3');
insert into artists values ('a11', 'Pitbull', 'American', 'uhasdf*3');
insert into artists values ('a12', 'Sia', 'Australian', 'uhasdf*3');
insert into artists values ('a13', 'Neon Trees', 'American', 'uhasdf*3');
insert into artists values ('a14', 'Carly Rae Jepsen', 'Canada', 'uhasdf*3');
insert into artists values ('a15', 'Calvin Harris', 'Scotland', 'uhasdf*3');
insert into artists values ('a16', 'Ellie Goulding', 'United Kingdom', 'uhasdf*3');
insert into artists values ('a17', 'Avicii', 'Swedish', 'uhasdf*3');
insert into artists values ('a18', 'Sean Paul', 'Jamaica', 'uhasdf*3');
insert into artists values ('a19', 'David Guetta', 'French', 'uhasdf*3');
insert into artists values ('a20', 'Bob Ezrin', 'Canadian', 'uhasdf*3');
insert into artists values ('a21', 'Echosmith', 'American', 'uhasdf*3');
insert into artists values ('a22', 'The Wanted', 'British', 'uhasdf*3');
insert into artists values ('a23', 'Selena Gomez', 'United States', 'uhasdf*3');
insert into artists values ('a24', 'Rixton', 'British', 'uhasdf*3');
insert into artists values ('a25', 'American Authors', 'American', 'uhasdf*3');
insert into artists values ('a26', 'Cobra Starship', 'American', 'uhasdf*3');
insert into artists values ('a27', 'Captial Cities', 'American', 'uhasdf*3');
insert into artists values ('a28', 'WALK THE MOON', 'United States', 'uhasdf*3');
insert into artists values ('a29', 'Jason Derulo', 'American', 'uhasdf*3');
insert into artists values ('a30', 'Taio Cruz', 'English', 'uhasdf*3');
insert into artists values ('a31', 'The Script', 'Ireland', 'uhasdf*3');
insert into artists values ('a32', 'Jennifer Lopez', 'American', 'uhasdf*3');
insert into artists values ('a33', 'Shakira', 'Colombia', 'uhasdf*3');
insert into artists values ('a34', 'The Weeknd', 'Canada', 'uhasdf*3');
insert into artists values ('a35', 'Celine Dion', 'Canada', 'uhasdf*3');
insert into artists values ('a36', 'Avril Lavigne', 'Canadian', 'uhasdf*3');
insert into artists values ('a37', 'Flo Rida', 'American', 'uhasdf*3');
